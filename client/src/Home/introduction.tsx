    ...
    return (
        <div className="flex items-center">
            ...
            <div className="sm:w-1/2">
                <img className="hidden sm:block h-48 bg-white px-8 mx-auto rounded" src="https://media.istockphoto.com/id/911713936/vector/four-aces-icon.jpg?s=612x612&w=0&k=20&c=aWBr5KTX6YQEuM_i7zqDDeeHqzVP_-09iPYmxEB5lwI="/>
            </div>
        </div>
    )
}
