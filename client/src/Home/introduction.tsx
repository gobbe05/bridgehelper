    ...
    return (
        <div className={`flex items-center rounded ${color?.colorMode == "light" ? "sm:bg-poker sm:text-white" : "sm:bg-white sm:text-gray-700"}`}>
            <div className={`sm:w-1/2  sm:p-8 transition-all`}>
                ...
                <p className="text-lg mt-2">Kom igång med att repetera dina Bridgekunskaper med hjälp av BridgeHelper, som består av 30 klickbara temaavsnitt syftande till att spegla Bridgefundamenta.</p>
            </div>
