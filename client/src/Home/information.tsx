        ...
        <div className="flex items-center mb-8">
            <div className={`flex flex-col ${color?.colorMode == "light" ? "sm:bg-poker sm:text-white" : "sm:bg-white sm:text-gray-600"} sm:p-8 lg:px-16 rounded transition-all`}>
                <div className='flex flex-col gap-4'>
                    ...
                    <Theme file={"/uploads/6 Tumregler _ Hörnstolpar.docx"} heading={"Behöver du endast snegla på ett antal Bridge-komihåg-ramsor går du direkt till tema 6​​​"} tema={"Tema 6"}/>
                    <Theme file={"/uploads/14 (a-b) En rundtur med budkedjan Öh1-Sh1-Öh2.docx"} heading={"Behöver du endast en överblick på kombinationer med de första buden Öh1, Sh1 och Öh2, går du direkt till tema 14"} tema={"Tema 14"}/>
                    <Theme file={"/uploads/16  Om öppning med något av buden 1X el 2NT el 2Kl.docx"} heading={"Behöver du endast en överblick på alternativ till öppningsbud vid spelstark hand (Hp=18+) går du direkt till tema 16​​"} tema={"Tema 16"}/>
                    <Theme file={"/uploads/30 Digital  Hjälpreda i Bridge . Ord och begrepp i Bridge.docx"} heading={"Behöver du endast tillgång till en alfabetisk bridge-ordlista, ​​​​går du direkt till tema 30.  ​​"} tema={"Tema 30"}/>
                </div>
                <p></p>
