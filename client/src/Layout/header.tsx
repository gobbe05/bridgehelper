...
function Header({ visitorCount } : {visitorCount: number | undefined}) {
    ...
    return (
        <div className="flex flex-col gap-2 lg:justify-center items-center h-64 lg:h-96">
            ...
            <p className="mr-auto text-black text-md bg-white p-2 px-4 rounded">Tidigare Besökare: {visitorCount}</p>
        </div>
    )
}
